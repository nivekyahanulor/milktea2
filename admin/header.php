  ...
  <head>
	...
	<?php
		...
		if ( $page == 'index.php'  ) {
            ...
            $products = 'active';
        }else if ($page == 'supplier.php' ) {
            $supplier = 'active';
        }else if ($page == 'rawmaterials.php' || $page == "rawmaterials-details.php") {
            $rawmaterials = 'active';
        }else if ($page == 'menu.php' ||$page == 'category.php' || $page == 'settings.php' || $page == 'voucher.php' ) {
            $settings = 'active';
        }
		?>
    <!-- Favicon -->
